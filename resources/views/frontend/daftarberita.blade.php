        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
              <div class="carousel-caption d-none d-md-block">
                    ...
                    <div class="row mb-3 ">
                        <h1 align="left" style="text-shadow: 2px 2px 10px #000000;">Daftar Berita</h1>
                        <h4 align="justify" style="text-shadow: 2px 2px 10px #000000;">Kumpulan berita SD Islam Bintang Juara</h4>
                    </div>
                    <div class="row mb-5">
                        <a>
                        </a>
