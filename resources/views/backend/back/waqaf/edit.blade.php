                        ...
                        <div class="card full-height">
                            <div class="card-header">
                                <div class="card-head-row">
                                    <div class="card-title">Edit Data Waqaf</div>
                                    <a href="{{route('waqaf.index')}}" class="btn btn-warning btn-sm ml-auto"> <i class="fas fa-undo"></i> Kembali </a>
                                </div>
                            </div>
                            <div class="card-body">
                                <form method="post" action="{{route('waqaf.update', $waqaf->id)}}" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    <div class="form-group">
                                        <label for="waqaf">Nama Bank</label>
                                        <input type="text" name="nama_bank" class="form-control" id="text" value="{{$waqaf->nama_bank}}">
                                    </div>
                                    <div class="form-group">
                                        <label for="waqaf">Nama Rekening</label>
                                        <input type="text" name="nama_rekening" class="form-control" id="text" value="{{$waqaf->nama_rekening}}">
                                    </div>
                                    <div class="form-group">
                                        <label for="waqaf">Nomor Rekening</label>
                                        <input type="text" name="nomor_rekening" class="form-control" id="text" value="{{$waqaf->nomor_rekening}}">
                                    </div>
                                    <div class="form-group">
                                        <label for="waqaf">Total Kebutuhan</label>
                                        <input type="text" name="total_kebutuhan" class="form-control" id="text" value="{{$waqaf->total_kebutuhan}}">
                                    </div>
                                    <div class="form-group">
                                        <label for="waqaf">Dana Terkumpul</label>
                                        <input type="text" name="dana_terkumpul" class="form-control" id="text" value="{{$waqaf->dana_terkumpul}}">
                                    </div>
                                    <div class="form-group">
                                        <label for="waqaf">Total Kekurangan</label>
                                        <input type="text" name="total_kekurangan" class="form-control" id="text" value="{{$waqaf->total_kekurangan}}">
                                    </div>
                                    <div class="form-group">
