...
<head>
	...
	<title>Tambah Gambar Jumbotron</title>
...
<body>
	<div class="wrapper">
        ...
        @include('backend.includes.sidebarjumbotron')
                ...
                <div class="card full-height">
                    <div class="card-header">
                        <div class="card-head-row">
                            ...
                            <a href="{{route('jumbotron.index')}}" class="btn btn-warning btn-sm ml-auto"> <i class="fas fa-undo"></i> Kembali </a>
                        </div>
                    </div>
                    <div class="card-body">
