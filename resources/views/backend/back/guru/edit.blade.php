...
<div class="wrapper">
    ...
    @include('backend.includes.sidebarguru')
                        ...
                        <div class="card full-height">
                            <div class="card-header">
                                <div class="card-head-row">
                                    <div class="card-title">Edit Data {{$guru->nama}}</div>
                                    <a href="{{route('guru.index')}}" class="btn btn-warning btn-sm ml-auto"> <i class="fas fa-undo"></i> Kembali </a>
                                </div>
                            </div>
                            <div class="card-body">
                                <form method="post" action="{{ route('guru.update', $guru->id)}}" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nama" class="form-control" id="text" value="{{$guru->nama}}">
                                    </div>
                                    <div class="form-group">
                                        <label for="guru">Jabatan</label>
                                        <input type="text" name="jabatan" class="form-control" id="text" value="{{$guru->jabatan}}">
                                    </div>
                                    <div class="form-group">
                                        <label for="guru">NIP</label>
                                        <input type="text" name="nip" class="form-control" id="text" value="{{$guru->nip}}">
                                    </div>
                                    <div class="form-group">
                                        <label for="gambar">Gambar Guru</label>
                                        <input type="file" name="foto" class="form-control">
                                        <br>
                                        <label for="gambar">Gambar Saat Ini</label><br>
                                        <img src="{{asset('uploads/'.$guru->foto) }}" width="100">
                                    </div>
                                    <div class="form-group">
