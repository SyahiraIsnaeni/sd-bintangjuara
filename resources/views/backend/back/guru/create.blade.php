                            ...
                            <div class="card-body">
                                <form method="post" action="{{ route('guru.store')}}" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="jabatan" class="form-control" id="text" placeholder="Enter Jabatan">
                                    </div>
                                    <div class="form-group">
                                        <label for="guru">NIP</label>
                                        <input type="text" name="nip" class="form-control" id="text" placeholder="Enter NIP">
                                    </div>
                                    <div class="form-group">
