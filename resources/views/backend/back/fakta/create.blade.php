                        ...
                        <div class="card full-height">
                            <div class="card-header">
                                <div class="card-head-row">
                                    <div class="card-title">Form Fakta SD</div>
                                    <a href="{{route('fakta.index')}}" class="btn btn-warning btn-sm ml-auto"> <i class="fas fa-undo"></i> Kembali </a>
                                </div>
                            </div>
                            <div class="card-body">
                                <form method="post" action="{{ route('fakta.store')}}" enctype="multipart/form-data">
                                    @csrf
                                    <div class="form-group">
                                        <label for="fakta">Jumlah Siswa</label>
                                        <input type="text" name="jumlah_siswa" class="form-control" id="text" placeholder="Enter Jumlah Siswa">
                                    </div>
                                    <div class="form-group">
                                        <label for="fakta">Jumlah Guru</label>
                                        <input type="text" name="jumlah_guru" class="form-control" id="text" placeholder="Enter Jumlah Guru">
                                    </div>
                                    <div class="form-group">
                                        <label for="fakta">Tahun Berjalan</label>
                                        <input type="text" name="tahun_berjalan" class="form-control" id="text" placeholder="Enter Tahun Berjalan">
                                    </div>
                                    <div class="form-group">
