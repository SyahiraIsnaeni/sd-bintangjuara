                        ...
                        <div class="card full-height">
                            <div class="card-header">
                                <div class="card-head-row">
                                    <div class="card-title">Data Fakta SD</div>
                                    <a href="{{route('fakta.create')}}" class="btn btn-info btn=sm ml-auto"> <i
                                            class="fas fa-plus"></i>Tambah Fakta SD </a>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="mt-4">
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            @forelse ($fakta as $row)
                                                <tr>
                                                    ...
                                                    <td>{{ $row->tahun_berjalan}}</td>
                                                    <td>
                                                        <a href="{{route('fakta.edit', $row->id) }}"
                                                           class="btn btn-warning btn-sm">Ubah</a>

                                                        <form action="{{route('fakta.destroy', $row->id)}}" method="post"
                                                              class="d-inline">
                                                            @csrf
                                                            @method('DELETE')
