...
<head>
	...
	<title>Tambah Kategori Pengumuman</title>
                ...
                <div class="card full-height">
                    <div class="card-header">
                        <div class="card-head-row">
                            <div class="card-title">Form Kategori Pengumuman</div>
                            <a href="{{route('kategoripengumuman.index')}}" class="btn btn-warning btn-sm ml-auto"> <i class="fas fa-undo"></i> Kembali </a>
                        </div>
                    </div>
                    <div class="card-body">
                        <form method="post" action="{{ route('kategoripengumuman.store')}}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="nama_kategori" class="form-control" id="text" placeholder="Enter Kategori Pengumuman">
                            </div>
                            <div class="form-group">
